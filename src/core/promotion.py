...
class Promoter:
    ...
    The munki and jira packages will be compared and the munki packages will be updated according to
    the state of the jira packages. Additionally automatic catalog transitions are realised if the right
    ...
    def _date_promotions(self):
        """
        If a package is tagged as autopromote and is longer than one week in its catalog it is moved
        to the next catalog. The jira package is updated.
        """
